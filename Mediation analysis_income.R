...
for (i in c(1,3,5)) {
  if(i==1){
    ...
    covariates=c("asthma_m", "agebirth_m_y", "matagesqu", "ethn3_m",  "asthma_bf") #Gen R
  }else {
...
png(
  file = "mediation_income_model_vers2.png", 
  width = 24, 
  height = 10.25, 
  units = "cm",
  res = 500)
...
yi_smk = c(effdecomp_smk_3$alspac$coefficients[1,1], effdecomp_smk_3$alspac$coefficients[2,1], effdecomp_smk_3$alspac$coefficients[3,1],
           effdecomp_smk_1$dnbc$coefficients[1,1], effdecomp_smk_1$dnbc$coefficients[2,1], effdecomp_smk_1$dnbc$coefficients[3,1],
           effdecomp_smk_5$eden$coefficients[1,1], effdecomp_smk_5$eden$coefficients[2,1], effdecomp_smk_5$eden$coefficients[3,1]) 
sei_smk = c(effdecomp_smk_3$alspac$coefficients[1,2], effdecomp_smk_3$alspac$coefficients[2,2], effdecomp_smk_3$alspac$coefficients[3,2],
            effdecomp_smk_1$dnbc$coefficients[1,2], effdecomp_smk_1$dnbc$coefficients[2,2], effdecomp_smk_1$dnbc$coefficients[3,2],
            effdecomp_smk_5$eden$coefficients[1,2], effdecomp_smk_5$eden$coefficients[2,2], effdecomp_smk_5$eden$coefficients[3,2])

forest(yi_smk, sei = sei_smk, atransf=exp,)

#Preg_smk and adverse reproductive outcomes:
effdecomp_ad_rep_1
effdecomp_ad_rep_3
effdecomp_ad_rep_5

yi_ad_rep = c(effdecomp_ad_rep_3$alspac$coefficients[1,1], effdecomp_ad_rep_3$alspac$coefficients[2,1], effdecomp_ad_rep_3$alspac$coefficients[3,1],
              effdecomp_ad_rep_1$dnbc$coefficients[1,1], effdecomp_ad_rep_1$dnbc$coefficients[2,1], effdecomp_ad_rep_1$dnbc$coefficients[3,1],
              effdecomp_ad_rep_5$eden$coefficients[1,1], effdecomp_ad_rep_5$eden$coefficients[2,1], effdecomp_ad_rep_5$eden$coefficients[3,1]) 
sei_ad_rep = c(effdecomp_ad_rep_3$alspac$coefficients[1,2], effdecomp_ad_rep_3$alspac$coefficients[2,2], effdecomp_ad_rep_3$alspac$coefficients[3,2],
               effdecomp_ad_rep_1$dnbc$coefficients[1,2], effdecomp_ad_rep_1$dnbc$coefficients[2,2], effdecomp_ad_rep_1$dnbc$coefficients[3,2],
               effdecomp_ad_rep_5$eden$coefficients[1,2], effdecomp_ad_rep_5$eden$coefficients[2,2], effdecomp_ad_rep_5$eden$coefficients[3,2])

forest(yi_ad_rep, sei = sei_ad_rep, atransf=exp,)
...
yi_bf = c(effdecomp_bf_3$alspac$coefficients[1,1], effdecomp_bf_3$alspac$coefficients[2,1], effdecomp_bf_3$alspac$coefficients[3,1],
          effdecomp_bf_1$dnbc$coefficients[1,1], effdecomp_bf_1$dnbc$coefficients[2,1], effdecomp_bf_1$dnbc$coefficients[3,1],
          effdecomp_bf_5$eden$coefficients[1,1], effdecomp_bf_5$eden$coefficients[2,1], effdecomp_bf_5$eden$coefficients[3,1]) 
sei_bf = c(effdecomp_bf_3$alspac$coefficients[1,2], effdecomp_bf_3$alspac$coefficients[2,2], effdecomp_bf_3$alspac$coefficients[3,2],
           effdecomp_bf_1$dnbc$coefficients[1,2], effdecomp_bf_1$dnbc$coefficients[2,2], effdecomp_bf_1$dnbc$coefficients[3,2],
           effdecomp_bf_5$eden$coefficients[1,2], effdecomp_bf_5$eden$coefficients[2,2], effdecomp_bf_5$eden$coefficients[3,2])

forest(yi_bf, sei = sei_bf, atransf=exp,)
...
yi_ets = c(effdecomp_ets_3$alspac$coefficients[1,1], effdecomp_ets_3$alspac$coefficients[2,1], effdecomp_ets_3$alspac$coefficients[3,1],
           effdecomp_ets_1$dnbc$coefficients[1,1], effdecomp_ets_1$dnbc$coefficients[2,1], effdecomp_ets_1$dnbc$coefficients[3,1],
           effdecomp_ets_5$eden$coefficients[1,1], effdecomp_ets_5$eden$coefficients[2,1], effdecomp_ets_5$eden$coefficients[3,1]) 
sei_ets = c(effdecomp_ets_3$alspac$coefficients[1,2], effdecomp_ets_3$alspac$coefficients[2,2], effdecomp_ets_3$alspac$coefficients[3,2],
            effdecomp_ets_1$dnbc$coefficients[1,2], effdecomp_ets_1$dnbc$coefficients[2,2], effdecomp_ets_1$dnbc$coefficients[3,2],
            effdecomp_ets_5$eden$coefficients[1,2], effdecomp_ets_5$eden$coefficients[2,2], effdecomp_ets_5$eden$coefficients[3,2])

forest(yi_ets, sei = sei_ets, atransf=exp,)


#####################Plot graphs################################################

effects <- data.frame(cbind(
  c("NDE", "NIE", "TE", "NDE", "NIE", "TE", "NDE", "NIE", "TE")))
...
png(
  file = "mediation_income_model.png", 
  width = 24, 
  height = 10.25, 
  units = "cm",
  res = 500)
...
forest(yi_smk, sei=sei_smk, ylim=c(0, 14), 
       rows=c(11:9, 7:5, 3:1),  at=log(c(0.75, 1, 5.0)), atransf=exp, showweights=FALSE,
       xlab="Risk Ratio", refline=log(1), 
       slab=effects$effect, mlab="Smoking during pregnancy")

#Add labels:
op <- par(cex=0.65, font=2)
text(c(0),     13.5, c("Smoking in pregnancy"))
op <- par(cex=0.6, font=2)
text(1.35, 12.5, "Risk ratio [95% CI]")

mtext('ALSPAC', side=2, at=10, line=2.75, adj=0.5)
mtext('DNBC', side=2, at=6, line=2.75, adj=0.5)
mtext('EDEN', side=2, at=2, line=2.75, adj=0.5)

par(op)

forest(yi_ad_rep, sei=sei_ad_rep, ylim=c(0, 14), 
       rows=c(11:9, 7:5, 3:1),  at=log(c(0.75, 1, 5.0)), atransf=exp, showweights=FALSE,
       xlab="Risk Ratio", refline=log(1), 
       slab=effects$effect, mlab="Adverse reproductive outcomes")

#Add labels:
op <- par(cex=0.65, font=2)
text(c(0.5),     13.5, c("Adverse reproductive outcomes"))
op <- par(cex=0.6, font=2)
text(1.35, 12.5, "Risk ratio [95% CI]")

par(op)

forest(yi_bf, sei=sei_bf, ylim=c(0, 14), 
       rows=c(11:9, 7:5, 3:1),  at=log(c(0.75, 1, 5.0)), atransf=exp, showweights=FALSE,
       xlab="Risk Ratio", refline=log(1), 
       slab=effects$effect, mlab="Breastfeeding")

#Add labels:
op <- par(cex=0.65, font=2)
text(c(0),     13.5, c("Breastfeeding"))
op <- par(cex=0.6, font=2)
text(1.35, 12.5, "Risk ratio [95% CI]")

par(op)

forest(yi_ets, sei=sei_ets, ylim=c(0, 14), 
       rows=c(11:9, 7:5, 3:1),  at=log(c(0.75, 1, 5.0)), atransf=exp, showweights=FALSE,
       xlab="Risk Ratio", refline=log(1), 
       slab=effects$effect, mlab="ETS")
